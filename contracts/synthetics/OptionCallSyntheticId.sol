...
contract OptionCallSyntheticId is IDerivativeLogic, ExecutableByThirdParty, HasCommission {
    ...
    constructor() public {
        ...
        */
        emit MetadataSet("{\"author\":\"xpluscal\",\"type\":\"option\",\"subtype\":\"call\",\"description\":\"Option Call logic contract\"}");
    }
